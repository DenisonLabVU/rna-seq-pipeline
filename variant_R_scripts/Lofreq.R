library(tidyverse)
library(dplyr)
df <- read.table("/Users/jennifergribble/Dropbox/SARS2_RDV_passage/21-9133.vcf", header = FALSE)
...
df$Ref_Total = as.numeric(df$Ref_F) + as.numeric(df$Ref_R)
...
df_coverage <- read.table("/Users/jennifergribble/Dropbox/SARS2_RDV_passage/21-9133_bowtie2.coverage.txt", header = FALSE)
...
write.table(df, "/Users/jennifergribble/Dropbox/SARS2_RDV_passage/21-9133_variant_freq.txt", sep = "\t", row.names = FALSE)
write.table(df_summary, "/Users/jennifergribble/Dropbox/SARS2_RDV_passage/21-9133_summary.txt", sep = "\t", row.names = FALSE)
write.table(df_transitions, "/Users/jennifergribble/Dropbox/SARS2_RDV_passage/21-9133_transitions.txt", sep = "\t", row.names = FALSE)
write.table(df_transversions, "/Users/jennifergribble/Dropbox/SARS2_RDV_passage/21-9133_transversions.txt", sep = "\t", row.names = FALSE)