...
report = pd.DataFrame(columns=['sample',
                               ...
                               "cutting_jfreq",
                               "jfreq"])
sample_list = [line.rstrip('\n') for line in open("/Users/gribblj/Dropbox/NHC_recombination/MHV_RNAseq_112020/Recombination/MHV_112020_samples.txt")]
report['sample'] = sample_list
#Set other variables
virus = "MHV"
wd = "/Users/gribblj/Dropbox/NHC_recombination/MHV_RNAseq_112020/Recombination/"
od = wd
exp = "MHV"
...
if Shannon_Entropy == True:
    ...
    # else:
    #     Min_Coverage = 0
    se_dir = "/Users/gribblj/Dropbox/NHC_recombination/MHV_RNAseq_112020/Recombination/Shannon_Entropy/"
